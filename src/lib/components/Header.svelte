    ...
    <div class="relative mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
        ...
        <div class="md:hidden h-[80px] relative">
                <div class="flex items-center justify-between h-full px-1 absolute inset-0">
                    ...
                    >
                        <div class="relative">
                            <div class="h-11 w-11 flex-shrink-0 rounded-full overflow-hidden bg-[#0c1838] ring-2 ring-blue-400/40">
                                <img
        ...
        <div class="hidden md:flex flex-col items-center pt-0 pb-0.5 md:flex-row md:items-center md:justify-between">
            <div class="flex items-center space-x-4">
                <div class="relative group">
                    <a
                        href="/"
                        class="flex h-20 w-20 items-center justify-center rounded-full overflow-hidden bg-[#0c1838] ring-2 ring-blue-400/40 transition-transform hover:scale-105"
                    >
                        <img
                            src="/images/referendum-logo.png"
                            alt="משאלי העם"

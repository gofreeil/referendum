...
// _site='referendum' — שיוך קשיח לאתר הזה; בלעדיו הפרסומת לא קיימת כאן.
...
// והבדיקה קשיחה: רק 'referendum' שייך לכאן. פרסומת בלי _site היא פרסומת
// ותיקה של "קהילה בשכונה" — לא מוצגת כאן.
const SITE_ID = 'referendum';

...
<div class="min-h-[80vh] flex items-center justify-center px-4 py-12" dir="rtl">
	<div class="w-full max-w-md rounded-3xl border border-white/10 bg-[#0f172a] p-8 shadow-2xl">
		...
		<button
			...
			class="mb-2 flex w-full items-center justify-center gap-2 rounded-2xl login-grad px-4 py-3.5 font-bold text-white transition hover:brightness-110 disabled:opacity-60 cursor-pointer"
		>
			{#if loading === 'sso'}
		...
		<button
			...
			disabled={loading !== null}
			class="mb-2 flex w-full items-center justify-center gap-2 rounded-2xl border border-purple-400/40 bg-purple-500/10 px-4 py-3 text-sm font-bold text-purple-100 transition hover:border-purple-400/60 hover:bg-purple-500/20 disabled:opacity-60 cursor-pointer"
		>
			{#if loading === 'sso'}

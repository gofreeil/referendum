		...
		{:else}
			...
			<div class="flex flex-col gap-2.5">
				...
				<button
					...
					class="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 font-bold text-gray-900 transition hover:bg-gray-50 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
				>
				...
				<button
					...
					disabled={oauthLoading !== null}
					class="flex w-full items-center justify-center gap-3 rounded-xl bg-[#1877F2] px-4 py-3 font-bold text-white transition hover:bg-[#166FE5] disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
				>
				...
				{/if}
				<a href="/register" class="mt-1 text-sm text-gray-400 underline hover:text-gray-200">מעדיפים אימייל וסיסמה? הרשמה ידנית</a>

<script>
    ...
    const LS_KEY = "ref_ad_builder_draft_v1";
            ...
            <section class="step-card">
                ...
                <div class="pay-box">
                    ...
                    {:else}
                        ...
                        <a
                            href={"https://wa.me/972587448061?text=" + encodeURIComponent(`שלום, אני מעלה פרסומת באתר משאלי העם ורוצה לתאם תשלום עבור ${payPlan.title} (${payPlan.price} ₪)`)}
                            target="_blank"
